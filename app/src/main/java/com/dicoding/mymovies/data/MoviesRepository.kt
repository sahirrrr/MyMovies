...
private constructor(
    ...
    companion object {
        ...
        fun getInstance(remoteDataSource: RemoteDataSource, localDataSource: LocalDataSource, appExecutors: AppExecutors): MoviesRepository =
                instance ?: synchronized(this) {
                    MoviesRepository(remoteDataSource, localDataSource, appExecutors).apply { instance = this }
                }
    }

    override fun getPopularFilm(): LiveData<Resource<PagedList<PopularFilmEntity>>> {
        return object : NetworkBoundResource<List<PopularFilmResults>, PagedList<PopularFilmEntity>>(appExecutors) {
    ...
    override fun getUpcomingFilm(): LiveData<Resource<PagedList<UpcomingFilmEntity>>> {
        return object : NetworkBoundResource<List<UpcomingFilmResults>, PagedList<UpcomingFilmEntity>>(appExecutors) {
    ...
    override fun getTopRatedSeries(): LiveData<Resource<PagedList<TopRatedSeriesEntity>>> {
        return object : NetworkBoundResource<List<TopRatedSeriesResults>, PagedList<TopRatedSeriesEntity>>(appExecutors) {
    ...
    override fun getPopularSeries(): LiveData<Resource<PagedList<PopularSeriesEntity>>> {
        return object : NetworkBoundResource<List<PopularSeriesResults>, PagedList<PopularSeriesEntity>>(appExecutors) {
    ...
    override fun getDetailSeries(tvId: Int): LiveData<Resource<DetailSeriesEntity>> {
        return object : NetworkBoundResource<DetailSeriesResponse, DetailSeriesEntity>(appExecutors) {
